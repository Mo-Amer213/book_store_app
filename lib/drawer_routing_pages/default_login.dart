                              ...
                              child: RichText(
                                text: TextSpan(
                                  children:<TextSpan>[
                                    ...
                                    TextSpan(text: ' Sign Up',style: TextStyle(fontWeight: FontWeight.bold,color: Color(0xffFEFEFD))),
                                  ]
                                ),
                              ),
                            ),
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(image: ExactAssetImage('images/facebook.png'),fit: BoxFit.cover),
                              //color: Colors.white,
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(image: ExactAssetImage('images/google.png'),fit: BoxFit.cover),
                                //color: Colors.white,
                                shape: BoxShape.circle,
                              ),
                            ),
    ...
    return SizedBox(
      ...
      child: Container(
        ...
        child: RaisedButton(
          ...
          child: Text('LOGIN'),
          onPressed: () {
            print('we  pushed he LOGIn button ');
          },
        ),
      ),
    );
